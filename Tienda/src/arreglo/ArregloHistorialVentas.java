...
public ArregloHistorialVentas(){
    ...
    Adicionar(new Venta(14, c1, LocalDate.of(2025, 5, 24), p1, 1, "Efectivo", "Boleta", e1));
    Adicionar(new Venta(35, c2, LocalDate.of(2025, 5, 24), p2, 1, "Efectivo", "Boleta", e2));
    Adicionar(new Venta(40, c3, LocalDate.of(2025, 5, 24), p3, 2, "Débito", "Factura", e3));
    Adicionar(new Venta(55, c4, LocalDate.of(2025, 5, 24), p4, 1, "Efectivo", "Boleta", e4));
    Adicionar(new Venta(60, c5, LocalDate.of(2025, 5, 24), p5, 3, "Crédito", "Factura", e5));
    Adicionar(new Venta(65, c6, LocalDate.of(2025, 5, 24), p6, 1, "Efectivo", "Factura", e6));
    Adicionar(new Venta(70, c7, LocalDate.of(2025, 5, 24), p7, 1, "Crédito", "Boleta", e7));
    Adicionar(new Venta(75, c8, LocalDate.of(2025, 5, 24), p8, 2, "Efectivo", "Factura", e8));
    Adicionar(new Venta(80, c9, LocalDate.of(2025, 5, 24), p9, 1, "Débito", "Boleta", e9));
    Adicionar(new Venta(85, c10, LocalDate.of(2025, 5, 24), p10, 3, "Efectivo", "Factura", e10));
